...
func testnetCmd(ctx *server.Context, cdc *codec.Codec,
	...
	cmd := &cobra.Command{
		Use:   "testnet",
		Short: "Initialize files for a 3zd testnet",
...
Example:
	3zd testnet --v 4 --output-dir ./output --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "3zd",
		"Home directory of the node's daemon configuration")
	cmd.Flags().String(flagNodeCLIHome, "3zcli",
...
func InitTestnet(
	...
	for i := 0; i < numValidators; i++ {
		...
		// TODO: Rename config file to server.toml as it's not particular to 3chainz
		// (REF: https://github.com/cosmos/cosmos-sdk/issues/4125).
		tzConfigFilePath := filepath.Join(nodeDir, "config/3zd.toml")
